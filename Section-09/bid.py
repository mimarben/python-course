...
while should_continue:
    ...
    if restart == "no":
        ...
        results= get_highest_bidder()
        print (f"The highest bidder is {results[0]} whit a bid: {results[1]}€")
    else:
        should_continue = True
        print("*"*20)